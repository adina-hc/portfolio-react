...
export default function NavBar() {
  return (
    <header className="bg-green-900 overflow-x-auto">
      <div className="container mx-auto flex justify-between">
        <nav className="flex">
          <NavLink
            ...
            className="inflex-flex items-center py-4 px-4 mr-4 text-green-100 hover:text-green-200 text-4xl font-bold cursive tracking-wide"
          >
            Adina
          </NavLink>
          <NavLink
        ...
        <div className="inline-flex py-3 px-3 my-3">
          ...
          {/* <SocialIcon
            url="https://twitter.com/Adi_D_Coder"
            className="mr-4"
            target="_blank"
            fgColor="#fff"
            style={{ height: 40, width: 40 }}
